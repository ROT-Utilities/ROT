...
cmd.dynamicType('join', 'join', (plr, _, args) => world.sendMessage(joinMsgFormat(args[0])), 'playerName');
cmd.dynamicType('leave', 'leave', (plr, _, args) => world.sendMessage(leaveMsgFormat(args[0])), 'playerName');
cmd.dynamicType('death', 'death', (plr, _, args) => world.sendMessage(deathMsgFormat(args[0])), 'playerName');
cmd.dynamicType('message', 'message', (plr, _, args) => world.sendMessage(msgFormat(args[0], args[1])), 'playerName2');
cmd.playerType('playerName', null, false);
cmd.playerType('playerName2', null, false, 'msg');
cmd.unknownType('msg', null);
